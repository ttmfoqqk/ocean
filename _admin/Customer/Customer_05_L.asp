...
Sub GetList()
	...
	with objCmd
		...
		.CommandText      = "OCEAN_BOARD_TAP_COMMUNITY_L"
	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<tr>
					<td colspan=2>
						<form name="AdminForm" method="post" action="Customer_05_P.asp">
						...
						<table cellpadding=0 cellspacing=0 width="100%" >
							...
							PageLink = "location.href='Customer_05_W.asp?" & PageParams & "&Idx=" & arrList(FI_Idx,iLoop) & "'"
							%>
				...
				<tr>
					<td align=center colspan=2>
						<a href="Customer_05_W.asp?<%=PageParams%>"><img src="../img/center_btn_write_ok.gif"></a>
