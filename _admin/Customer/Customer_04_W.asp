...
Sub GetList()
	...
	with objCmd
		...
		.CommandText      = "OCEAN_BOARD_TAP_DOWNLOAD_V"
	...
	<tr>
		...
		<td class=center_cont_area valign=top>
			...
			<table cellpadding=0 cellspacing=0 width="100%" >
				...
				<form name="AdminForm" method="POST" action="Customer_04_P.asp" onsubmit="return check()">
				...
				<tr>
					<td align=center colspan=2>
						...
						<a href="Customer_04_L.asp?<%=PageParams%>"><img src="../img/center_btn_list.gif" style="vertical-align:top;"></a>
